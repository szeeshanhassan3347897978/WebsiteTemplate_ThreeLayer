<%@ Control Language="C#" AutoEventWireup="true" CodeFile="dummyControl.ascx.cs" Inherits="Admin_AdminControls_Sale" %>
        ...
        <div id="Sales-Add">
            ...
            <div class="form-inline  clearfix" style="margin-bottom: 15px;">
                ...
                <div class="form-group  col-md-3">
                    ...
                    <input type="text" class="form-control" id="txtReceivedAmount" placeholder="">
                </div>
        ...
        $.ajax({
            ...
            success: function (msg) {
                if (msg.d.Item2 == 0) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        if (i == 0) {
                            html += '<option class="form-control" selected="selected" value="' + data[i].ACC_ID + '">' + data[i].ACC_NAME + '</option>';
                        }
                    else
                    {
                        html += '<option class="form-control" value="' + data[i].ACC_ID + '">' + data[i].ACC_NAME + '</option>';
                        }
                    }
